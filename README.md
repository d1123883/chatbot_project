...
- <img width="1905" height="1070" alt="image" src="https://github.com/user-attachments/assets/8d7366d9-9734-480c-aca5-8c4eec27998a" />

- `history.png`：對話歷史或多 session 切換的畫面
<img width="1904" height="1065" alt="image" src="https://github.com/user-attachments/assets/15f1c9d2-f878-41a8-a3d3-546cd0220c22" />
...
> /prd 最好，所有程式的開端都從這裡開始，所以有種整個程式都靠他的感覺。  /test 最差，做完之後還是一堆問題，需要反覆debug。我認為是因為程式碼終究會跟環境發生底層衝突，test頂多只能根據程式完整度進行測試。
---
